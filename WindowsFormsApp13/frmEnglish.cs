...
namespace WindowsFormsApp13
{
    public partial class frmEnglish : Form
    {
        ...
        public short CountSpaces(string Word)
        {
            ...
            lblChars.Text = Length(textBox1.Text).ToString();
        ...
        private bool IsArabicCharacter(char c)
        {
            ...
            int arabicStart = 0x0600;
            int arabicEnd = 0x06FF;

            // Check if the character falls within the Arabic range
            return c >= arabicStart && c <= arabicEnd;
        }

        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
           // Check if the pressed key is an Arabic character
